...
df_variable <- read_excel("C:/Users/cesar/OneDrive/Escritorio/TrabajoFecundidadyHogares/Dashboard/Basefinal.xlsx", sheet = "epf")
```
...
df_nacimientos <- read_excel("C:/Users/cesar/OneDrive/Escritorio/TrabajoFecundidadyHogares/Dashboard/Basefinal.xlsx", sheet = "Nacimientos")
...
library(ggplot2)
# Leer datos
epf <- read_delim("C:/Users/cesar/OneDrive/Escritorio/TrabajoFecundidadyHogares/Dashboard/epf_persona.csv", delim = ";", 
...
epf <- read_delim("C:/Users/cesar/OneDrive/Escritorio/TrabajoFecundidadyHogares/Dashboard/epf_persona.csv", delim = ";", 
                  escape_double = FALSE, trim_ws = TRUE)
df_variable <- read_excel("C:/Users/cesar/OneDrive/Escritorio/TrabajoFecundidadyHogares/Dashboard/Basefinal.xlsx", 
                          sheet = "epf")
...
https://github.com/CesarSM04/Fecundidad_hogares
